...
def test_create_receipt(db_receipt_manager,db_address_manager,db_payment_manager, base_cart_item):
    id_user = 1
    id_cart = 1
    ...
    receipt_created = db_receipt_manager.create_receipt(id_cart, id_address, id_payment, id_user=id_user)
