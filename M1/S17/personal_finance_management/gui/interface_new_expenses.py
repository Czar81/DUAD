...
def _make_new_expenses_interface():
    """
    Creates a modal window for adding new expense entries.
    """
    # ------ Constants ------
    light_blue="#4A5C6A"
    gray="#D9D9D9"
    ...
    # Catch-all for unexpected errors
        ...
        fsg.popup_error(f"An unexpected error ocurred trying to display New Expenses: {error}", title="Error in New Expenses")